...
% Bibliography
\usepackage[numbers,sort&compress]{natbib}  % automatically reorder inline citations
...
\DeclareAcronym{IDE}{
    short = IDE,
    long = interdigitated electrode,
    short-plural = s,
    long-plural = s
}
\DeclareAcronym{HCW}{
    short = HCW,
    long = healthcare worker,
    short-plural = s,
    long-plural = s
}
\DeclareAcronym{EIS}{
...
% Front matter
\input{frontmatter/stellenbosch_title_page}
