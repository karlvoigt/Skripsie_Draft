...
Vroeë siekte-sifting deur die opsporing van biomerkers het die potensiaal vir betekenisvolle gesondheidsorgvoordele, veral in hulpbron-beperkte punt-van-sorg (PVS) omgewings. Impedansie-ontleders wat elektrochemiese impedansie-spektroskopie (EIS) op interdigitale elektrodes (IDEs) gebruik, bied 'n belowende benadering vir sulke toepassings. Kommersiële toestelle is egter dikwels onbekostigbaar duur en vereis gespesialiseerde kennis om gebruik te word, wat hul nuttigheid in POC-omgewings beperk. Hierdie projek beskryf die ontwerp van BioPal, 'n lae-koste gemultiplekseerde impedansie-ontleder stelsel wat ontwerp is om gebruikersvriendelik te wees vir gesondheidsorgwerkers (GWs).
...
Die toestel is gekalibreer en getoets teenoor die PalmSens4. Validasie het sub-3\% foutmarges vir fosfaatgebufferde soutoplossing (PBS) metings getoon en suksesvolle onderskeiding tussen verskillende konsentrasies (20, 50 en 100 mg/mL) van beeserumalbumien (BSA) proteïenbinding gedemonstreer. Met 'n koste van R2,000, bied hierdie projek 'n getoetse platform vir verdere ontwikkeling na toeganklike en bekostigbare PVS biosensing-toepassings aan.
